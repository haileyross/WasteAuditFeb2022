...
visualize(boot_missorted) +
  ...
  labs(title = "Simulated Bootstrap Distribution of Overall Missorted Waste", x = "Sample Mean", y = "Count")
```
...
visualize(boot_missorted_tr) +
  ...
  labs(title = "Simulated Bootstrap Distribution of Overall Trash & Recycling", x = "Sample Mean", y = "Count")
```
...
visualize(boot_missorted_trash) +
  ...
  labs(title = "Simulated Bootstrap Distribution of Missorted Trash", x = "Sample Mean", y = "Count")
```
...
visualize(boot_missorted_recycling) +
  ...
  labs(title = "Simulated Bootstrap Distribution of Missorted Recycling", x = "Sample Mean", y = "Count")
```
...
visualize(boot_missorted_compost) +
  ...
  labs(title = "Simulated Bootstrap Distribution of Missorted Compost", x = "Sample Mean", y = "Count")
```
...
```{r locaiton-contamination-table}
